defmodule Partypeli.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    children = [
      ...
      supervisor(Partypeli.Game.EventManager, [])
    ...
    opts = [strategy: :one_for_one, name: Partypeli.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    PartypeliWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
